...
class TestOnboardingProgress:
    def test_auto_advance_profile_questionnaire_routine_session(self, client):
        ...
        # 4) First completed session (no coins) auto-completes tutorial (+50)
        ...
        assert "tutorial_complete" in progress.get("coins_awarded", [])
        assert me["currency"] == 200
